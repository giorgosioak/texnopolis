...
import '../widgets/coming_soon_list_card.dart';
...
class ComingSoonScreen extends StatefulWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text(AppLocalizations.of(context)!.comingSoon),centerTitle: true,
        actions: [
          IconButton(
      ...
      body: FutureBuilder<List<Movie>>(
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            return const Center(child: Text('No movies available.'));  // TODO
          }
